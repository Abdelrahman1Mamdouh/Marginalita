...
<asp:Content ID="content" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <asp:SqlDataSource runat="server" ID="TabellaProgetto"
        ...
        SelectCommand="SELECT ID, Nome FROM Progetto"></asp:SqlDataSource>

    <asp:SqlDataSource runat="server" ID="TabellaDipendente"
        ConnectionString="Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=|DataDirectory|\dgs.mdf;Integrated Security=True;TrustServerCertificate=True"
        SelectCommand="SELECT ID, Nome, Cognome, CostoOrario FROM Dipendente"></asp:SqlDataSource>
    ...
    <asp:SqlDataSource runat="server" ID="VistaAssenti"
        ConnectionString="Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=|DataDirectory|\dgs.mdf;Integrated Security=True;TrustServerCertificate=True"
        SelectCommand="SELECT ID, Dipendente, Motivo, Ore, DataAssenze FROM OreAssenze"></asp:SqlDataSource>

    <asp:SqlDataSource runat="server" ID="TabellaMotivo"
        ConnectionString="Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=|DataDirectory|\dgs.mdf;Integrated Security=True;TrustServerCertificate=True"
        SelectCommand="SELECT ID, Descrizione FROM Motivo"></asp:SqlDataSource>
